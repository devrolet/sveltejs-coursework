...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 58, 6, 1231);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (56:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(56:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 52, 2, 988);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 53, 2, 1004);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 51, 0, 976);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 56, 4, 1074);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$1, 57, 4, 1095);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$1, 58, 4, 1116);
    			add_location(div0, file$1, 55, 2, 1064);
    			add_location(div1, file$1, 60, 2, 1148);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$1, 54, 0, 1040);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 29, 2, 509);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file, 28, 0, 497);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
