    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (title === undefined && !('title' in $$props || $$self.$$.bound[$$self.$$.props['title']])) {
    			console_1$2.warn("<CartItem> was created without expected prop 'title'");
    		}

    		if (price === undefined && !('price' in $$props || $$self.$$.bound[$$self.$$.props['price']])) {
    			console_1$2.warn("<CartItem> was created without expected prop 'price'");
    		}

    		if (id === undefined && !('id' in $$props || $$self.$$.bound[$$self.$$.props['id']])) {
    			console_1$2.warn("<CartItem> was created without expected prop 'id'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<CartItem> was created with unknown prop '${key}'`);
    	});
