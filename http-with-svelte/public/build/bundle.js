    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file, 74, 0, 1869);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 76, 4, 1911);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(76:4) {#each $hobbyStore as hobby}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 67, 0, 1688);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "hobby");
    			add_location(input, file, 68, 0, 1721);
    			attr_dev(button, "class", "svelte-1jd30lr");
    			add_location(button, file, 69, 0, 1775);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let addHobby = () => {
    		...
    		fetch('https://meetup-svelte-app-default-rtdb.firebaseio.com/hobbies.json', {
    			...
    			$$invalidate(1, isLoading = false); // res.json() => Promise with a object that contains the id
    			console.log(err);
    		});
    	};
