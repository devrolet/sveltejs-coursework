...
var app = (function () {
    ...
    /* src/CartItems.svelte generated by Svelte v3.59.2 */

    const file$2 = "src/CartItems.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 4, 0, 60);
    			add_location(button, file$2, 5, 0, 84);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('CartItems', slots, []);
    	let { title } = $$props;
    	let { id } = $$props;

    	$$self.$$.on_mount.push(function () {
    		if (title === undefined && !('title' in $$props || $$self.$$.bound[$$self.$$.props['title']])) {
    			console.warn("<CartItems> was created without expected prop 'title'");
    		}

    		if (id === undefined && !('id' in $$props || $$self.$$.bound[$$self.$$.props['id']])) {
    			console.warn("<CartItems> was created without expected prop 'id'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<CartItems> was created with unknown prop '${key}'`);
    	});
    ...
    class CartItems extends SvelteComponentDev {
    	...
    	get title() {
    		throw new Error("<CartItems>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set title(value) {
    		throw new Error("<CartItems>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 38, 8, 666);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(38:4) {#if member.isParent}",
    		ctx
    	});
    ...
    // (40:12) {#each member.children as child}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:12) {#each member.children as child}",
    		ctx
    	});
    ...
    // (72:4) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:4) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 62, 0, 1546);
    			add_location(button1, file, 64, 4, 1609);
    			attr_dev(div, "class", "svelte-1yif191");
    			add_location(div, file, 63, 0, 1599);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    			...
    			children: [
    				{
    					isParent: true,
    					name: "Amber",
    					children: [{ isParent: false, name: "Angel" }]
    				}
    			]
    		},
    	...
    	let switchTitle = () => {
    		$$invalidate(1, currentTitle = "That app over there");
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('switchTitle' in $$props) $$invalidate(5, switchTitle = $$props.switchTitle);
    	};
