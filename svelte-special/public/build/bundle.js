...
var app = (function () {
    ...
    const file$1 = "src/CartItems.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 4, 0, 60);
    			add_location(button, file$1, 5, 0, 84);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	cartitems = new CartItems({
    			props: { title: "Another Product", id: "p2" },
    			$$inline: true
    		});

    	const block = {
    		c: function create() {
    			create_component(cartitems.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(cartitems, target, anchor);
    			current = true;
    		},
    		...
    		d: function destroy(detaching) {
    			destroy_component(cartitems, detaching);
    		}
    	};
    ...
    function create_if_block(ctx) {
    	...
    	product = new Product({
    			props: { title: "Test Product", id: "p1" },
    			$$inline: true
    		});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 12, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let toggle = () => {
    		$$invalidate(0, showProduct = !showProduct);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ('showProduct' in $$props) $$invalidate(0, showProduct = $$props.showProduct);
