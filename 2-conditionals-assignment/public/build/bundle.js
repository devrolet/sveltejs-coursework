...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			strike.textContent = "Add a password input field and save the user input in a variable.";
    			t5 = space();
    			li1 = element("li");
    			...
    			t17 = space();
    			input = element("input");
    			add_location(h1, file, 4, 0, 66);
    			add_location(p, file, 6, 0, 87);
    			add_location(strike, file, 9, 5, 124);
    			add_location(li0, file, 9, 1, 120);
    			add_location(li1, file, 10, 1, 213);
    			add_location(li2, file, 11, 1, 326);
    			add_location(li3, file, 12, 1, 409);
    			add_location(li4, file, 13, 1, 480);
    			add_location(li5, file, 14, 1, 558);
    			add_location(ol, file, 8, 0, 114);
    			attr_dev(label, "for", "pw-input");
    			add_location(label, file, 17, 0, 632);
    			attr_dev(input, "id", "pw-input");
    			attr_dev(input, "type", "password");
    			add_location(input, file, 18, 0, 677);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [password, input_input_handler];
    }
