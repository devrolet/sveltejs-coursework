    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(/*goal*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-4qyjo2");
    			toggle_class(h1, "highlight", /*doHighlight*/ ctx[1]);
    			add_location(h1, file$1, 12, 0, 144);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (goal === undefined && !('goal' in $$props || $$self.$$.bound[$$self.$$.props['goal']])) {
    			console.warn("<Goal> was created without expected prop 'goal'");
    		}
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			strike2.textContent = "Put the h1 tag + output into a separate component to which you pass the user input";
    			t11 = space();
    			label = element("label");
    			label.textContent = "What is your goal for this course?";
    			t13 = space();
    			input = element("input");
    			t14 = space();
    			...
    			add_location(strike0, file, 11, 6, 139);
    			add_location(li0, file, 11, 2, 135);
    			add_location(strike1, file, 12, 6, 228);
    			add_location(li1, file, 12, 2, 224);
    			add_location(li2, file, 13, 2, 287);
    			add_location(strike2, file, 17, 4, 407);
    			add_location(li3, file, 16, 2, 398);
    			add_location(ol, file, 10, 0, 128);
    			attr_dev(label, "for", "course-goal");
    			add_location(label, file, 21, 0, 522);
    			attr_dev(input, "id", "course-goal");
    			attr_dev(input, "type", "text");
    			add_location(input, file, 22, 0, 590);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			const goal_changes = {};
    			if (dirty & /*courseGoal*/ 1) goal_changes.goal = /*courseGoal*/ ctx[0];
