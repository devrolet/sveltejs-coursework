...
var app = (function () {
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 81, 6, 1381);
    			this.first = div;
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 79, 2, 1315);
    			attr_dev(div1, "class", "page svelte-1a1ekzd");
    			add_location(div1, file$1, 78, 0, 1294);
    		},
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 61, 8, 1693);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "introstart", /*introstart_handler*/ ctx[7], false, false, false, false),
    					listen_dev(div, "introend", /*introend_handler*/ ctx[8], false, false, false, false),
    					listen_dev(div, "outrostart", /*outrostart_handler*/ ctx[9], false, false, false, false),
    					listen_dev(div, "outroend", /*outroend_handler*/ ctx[10], false, false, false, false)
    				];
    		...
    		o: function outro(local) {
    			...
    			if (local) {
    				div_outro = create_out_transition(div, fly, { easing: cubicIn, x: 0, y: 300 });
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:4) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 44, 0, 966);
    			add_location(hr, file, 49, 0, 1114);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 51, 0, 1120);
    			add_location(button1, file, 52, 0, 1163);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('addBox' in $$props) $$invalidate(3, addBox = $$props.addBox);
    		if ('discard' in $$props) $$invalidate(4, discard = $$props.discard);
    	};
